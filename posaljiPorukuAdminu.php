...
<body>
    ...
    $dbname = "id18650421_dentalclinic";
            ...
            $sql = "SELECT email, ime, prezime FROM korisnici WHERE tip = '$admin'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<script>alert('Uspesno poslali poruku administratoru!')</script>";
